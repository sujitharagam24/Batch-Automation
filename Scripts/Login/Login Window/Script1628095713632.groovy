...
Windows.verifyElementPresent(findWindowsObject('Object Repository/Login/CheckBox'), 10)

Windows.verifyElementPresent(findWindowsObject('Object Repository/Login/ButtonOK'), 10)
