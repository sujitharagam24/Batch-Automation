...
List<WebElement> elementList = WebUI.findWebElements(findTestObject('Object Repository/My Work Page Objectory/US8761/Document Number Column Items'), 5);
...
WebUI.click(findTestObject('Object Repository/My Work Page Objectory/US8761/Document Number Column'))

ArrayList<Integer> sortedList = new ArrayList<Integer>()

List<WebElement> elementsList = WebUI.findWebElements(findTestObject('Object Repository/My Work Page Objectory/US8761/Document Number Column Items'), 5);
