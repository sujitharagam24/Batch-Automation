...
/**
 * Verify that paging exists for queues with long lists
 * @author michele.jazo
 *
 */
...
WebUI.click(findTestObject('Object Repository/My Work Page Objectory/Navigation/svg_Deed - Historical_mud-icon-root mud-svg_f4f585'))
