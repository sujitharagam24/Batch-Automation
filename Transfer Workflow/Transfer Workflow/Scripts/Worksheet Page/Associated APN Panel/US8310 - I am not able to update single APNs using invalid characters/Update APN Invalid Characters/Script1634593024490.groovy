 ...
 * Update APN and verify validation exists when using invalid characters.
 * @author michele.jazo
 *
 */
...
WebUI.waitForElementPresent(findTestObject('Object Repository/APN Panel/UpdateButton'), 10)
...
errormg = WebUI.getText(findTestObject('Object Repository/APN Panel/Invalid Character Msg'))

System.out.println(errormg);

if (!(errormg.toString().contains('Only numerical characters can be entered.'))) {
	KeywordUtil.markFailed('APN Validation message does not contain expected text.')
}
