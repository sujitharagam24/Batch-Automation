 ...
 * Verify Associated APN panel exists. Add duplicate APN and verify validation exists.
 * @author michele.jazo
 *
 */
...
errormg = WebUI.getText(findTestObject('Object Repository/APN Panel/Duplicate APN Msg'))

System.out.println(errormg);

if (!(errormg.toString().contains('is already associated with the Document.'))) {
	KeywordUtil.markFailed('Duplicate APN message does not contain expected text.')
}
