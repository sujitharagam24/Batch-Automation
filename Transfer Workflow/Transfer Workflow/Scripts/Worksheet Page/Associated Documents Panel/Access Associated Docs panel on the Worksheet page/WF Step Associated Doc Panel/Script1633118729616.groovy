 ...
 * Verify Associated Documents WF Step data is expected value
 * @author michele.jazo
 *
 */
...
wfstep = WebUI.getText(findTestObject('Object Repository/Associated Documents/Associated Documents Data/td_Sales CPT with Sale'))
