...
// Get the value of Street field

def street = WebUI.getAttribute(findTestObject('Object Repository/Worksheet Page Objectory/Feature8308 - Recorded Information on Worksheet Page/Street'), 'value')

// Get the value of City field

def city = WebUI.getAttribute(findTestObject('Object Repository/Worksheet Page Objectory/Feature8308 - Recorded Information on Worksheet Page/City'), 'value')

// Get the value of State field

def state = WebUI.getAttribute(findTestObject('Object Repository/Worksheet Page Objectory/Feature8308 - Recorded Information on Worksheet Page/State'), 'value')

// Get the value of Zip field

def zip = WebUI.getAttribute(findTestObject('Object Repository/Worksheet Page Objectory/Feature8308 - Recorded Information on Worksheet Page/Zip Code'), 'value')
...
//Next Step is to get Address on Workflow History Page by clicking on Status button and verify
