...
/**
 * Validation check occurs for Event Date field on the Accessor Panel 
...
/* Get the value of APN field */

def apnValue = WebUI.getText(findTestObject('Object Repository/Worksheet Page Objectory/US8478/Lead APN'));
