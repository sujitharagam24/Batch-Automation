...
WebUI.click(findTestObject('Object Repository/Follow Up Panel/span_Add a Note'))

WebUI.click(findTestObject('Follow Up Panel/svg_Delete'))

WebUI.click(findTestObject('Follow Up Panel/span_Delete'))
