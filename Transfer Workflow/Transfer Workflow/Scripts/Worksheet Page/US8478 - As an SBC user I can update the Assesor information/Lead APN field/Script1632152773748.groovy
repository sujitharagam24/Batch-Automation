...
/**
 * Validation check occurs for Lead APN field on the Accessor Panel 
...
/* Get the value of APN */

def leadAPN = WebUI.getText(findTestObject('Worksheet Page Objectory/US8478/Lead APN'));
...
// Get the value of Lead APN field 
