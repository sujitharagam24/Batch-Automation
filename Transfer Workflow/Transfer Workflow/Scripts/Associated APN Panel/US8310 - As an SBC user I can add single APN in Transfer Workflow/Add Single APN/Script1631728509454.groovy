...
WebUI.click(findTestObject('APN Panel/div_Associated APNs'))

WebUI.click(findTestObject('APN Panel/button_Add APN'))

WebUI.setText(findTestObject('APN Panel/input_Lead APN_mud-input-slot mud-input-roo_ff250c'), 
    '1234567891234')

WebUI.click(findTestObject('APN Panel/span_Add'))

WebUI.click(findTestObject('APN Panel/div_Associated APN added'))

WebUI.click(findTestObject('APN Panel/span_Close'))

WebUI.click(findTestObject('APN Panel/td_1234567891234'))
