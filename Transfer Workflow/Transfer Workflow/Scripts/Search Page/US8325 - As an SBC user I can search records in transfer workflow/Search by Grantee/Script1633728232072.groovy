...
WebUI.setText(findTestObject('Search Page Objectory/US8325/Search Grantee'), 
    'test')
...
findTestObject('Object Repository/Search Page Objectory/US8325/div_mud-table-pagination-actions')
