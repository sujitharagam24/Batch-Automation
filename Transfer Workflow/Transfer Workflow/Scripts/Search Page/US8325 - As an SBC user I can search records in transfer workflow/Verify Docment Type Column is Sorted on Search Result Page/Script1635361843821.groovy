...
List<WebElement> elementList = WebUI.findWebElements(findTestObject('Object Repository/Search Page Objectory/US8325/Search Result Document Type Column Items'), 
    2)
...
WebUI.click(findTestObject('Object Repository/Search Page Objectory/US8325/Search Result Document Type Column'))

ArrayList<String> sortedList = new ArrayList<String>()

List<WebElement> elementsList = WebUI.findWebElements(findTestObject('Object Repository/Search Page Objectory/US8325/Search Result Document Type Column Items'), 
    2)
