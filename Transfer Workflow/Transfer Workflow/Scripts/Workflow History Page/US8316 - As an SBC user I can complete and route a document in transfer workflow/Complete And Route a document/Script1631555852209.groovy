...
/**
 * Click on Complete and Route Radio button to complete and route a document on Workflow section
...
WebUI.click(findTestObject('Workflow History Page/US8314/Workflow Section/Complete and Route radio button'))
...
//assertTrue(selectedText.startsWith(clickedText));
