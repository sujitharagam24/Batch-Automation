...
/**
 * Click on Verify Radio button to verify a document on Workflow section
...
/* Check Verify Radio button */
WebUI.click(findTestObject('Workflow History Page/US8314/Workflow Section/Verify radio button'))
