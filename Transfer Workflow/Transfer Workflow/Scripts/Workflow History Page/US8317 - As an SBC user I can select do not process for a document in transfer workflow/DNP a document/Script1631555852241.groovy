...
/**
 * Click on DNP Radio button to DNP a document on Workflow section
...
/* Check DNP Radio button */
WebUI.click(findTestObject('Workflow History Page/US8314/Workflow Section/DNP radio button'))
