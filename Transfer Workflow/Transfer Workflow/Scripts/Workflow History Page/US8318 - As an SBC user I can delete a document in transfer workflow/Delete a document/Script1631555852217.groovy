...
/**
 * Click on Delete button to delete a document on Workflow section
...
/* Check Delete Radio button */
WebUI.click(findTestObject('Workflow History Page/US8314/Workflow Section/Delete radio button'))
