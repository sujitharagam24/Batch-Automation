...
/**
 *
 * Access the Workflow History Page and verify all the data match the search result data
...
def recordedDocWH = WebUI.getAttribute(findTestObject('Object Repository/Workflow History Page/US8480/RecordedDoc on WH'), 'value')

def docTypeOnWH =  WebUI.getAttribute(findTestObject('Object Repository/Workflow History Page/US8480/Recorded Doc Type onWH'), 'value')

def recordedDateOnWH =  WebUI.getAttribute(findTestObject('Object Repository/Workflow History Page/US8480/Recorded Date on WH'), 'value')

def leadAPNonWH = WebUI.getAttribute(findTestObject('Object Repository/Workflow History Page/US8480/Lead APN on WH'), 'value')

assertTrue(recordedDocOnSearch.equals(recordedDocWH))
assertTrue(docTypeOnSearch.equals(docTypeOnWH))
assertTrue(recordedDateOnSearch.equals(recordedDateOnWH))
assertTrue(leadAPNonSearch.equals(leadAPNonWH))
