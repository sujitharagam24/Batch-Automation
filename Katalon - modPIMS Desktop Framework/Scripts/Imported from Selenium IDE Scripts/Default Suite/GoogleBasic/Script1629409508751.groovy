...
"type | name=q | katalon studio tutorial | "
selenium.type("name=q", "katalon studio tutorial")

"sendKeys | name=q | KEY_ENTER | "
selenium.sendKeys("name=q", Keys.ENTER)

"mouseOver | css=.RzdJxc:nth-child(1) .WZIVy |  | "
selenium.mouseOver("css=.RzdJxc:nth-child(1) .WZIVy")

"mouseOut | css=.RzdJxc:nth-child(1) .WZIVy |  | "
selenium.mouseOut("css=.RzdJxc:nth-child(1) .WZIVy")
